...
private static WebDriver driver;
	...
	public static void reportar(String categoria, String responsavel, String resumo, String descricao) throws IOException {
		// Usando pageObject
		principalPagina.reportar_lnk(driver).click();
		reportarBugPagina.categoria_drop(categoria);
		...
		reportarBugPagina.responsavel_drop(responsavel);
		...
		utils.takeScreenshot("bugReportado_");
